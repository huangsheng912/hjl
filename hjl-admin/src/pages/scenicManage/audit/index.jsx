...
class Main extends React.Component {
  ...
  render() {
    const {
      totalAddress, largeAmountAddress, list = [], total,
      minBalance, maxBalance, minIncome, maxIncome, address, tableLoading,page
    } = this.state;
    const columns=[
      {
        title: '序号',
    ...
    return (
      <div className='audit-page'>
        <div className='table-search'>
          ...
          <span className='search-label'>非小额地址数：{largeAmountAddress}</span>
        </div>
        <div className='bg-white'>
          <div className='list-search hidden'>
            <div className='fl'>
              余额&nbsp;&nbsp;&nbsp;
              <Input value={minBalance} onChange={(v)=>this.changeMinBalance(v,'minBalance')} />
              &nbsp;&nbsp;-&nbsp;&nbsp;
              <Input value={maxBalance} onChange={(v)=>this.changeMinBalance(v,'maxBalance')}/>
            </div>
            <div className='fl'>
              总收益&nbsp;&nbsp;&nbsp;
              <Input value={minIncome} onChange={(v)=>this.changeMinBalance(v,'minIncome')} />
              &nbsp;&nbsp;-&nbsp;&nbsp;
              <Input value={maxIncome} onChange={(v)=>this.changeMinBalance(v,'maxIncome')}/>
            </div>
            <div className='fl address-search'>
              地址&nbsp;&nbsp;&nbsp;
              <Input value={address} onChange={(v)=>this.changeMinBalance(v,'address')} placeholder='查询地址'/>
            </div>
            <div className='fr'>
