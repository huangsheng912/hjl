...
class Main extends React.Component {
  ...
  render() {
    ...
    const {scenicList, pictures,  visible, previewImgs, activeIndex,
      defaultValue, showEditorError} = this.state
      ...
      <div className='edit-scenic-page'>
        <Form {...formItemLayout} style={{maxWidth: '700px'}}>
          ...
          <Form.Item label="景点介绍" className='editor-item'>
            ...
            <div className="ant-form-explain">{showEditorError?'请输入景点介绍':''}</div>
          </Form.Item>
