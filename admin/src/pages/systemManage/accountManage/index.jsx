      ...
      },
      {
        ...
        render: (text, record) => (
          <span>
            ...
            <a onClick={()=>this.showConfirm({title: '确认重置该用户密码？', record, cb: this.resetPs})}>重置密码</a>
            <Divider type="vertical" />
            {!record.admin?
              <a onClick={()=>this.showConfirm({title: '确认设置该用户为管理员？',record,cb: this.setAdmin})} >成为管理员</a>
              :<a onClick={()=>this.showConfirm({title: '确认取消该用户管理员权限？',record,cb: this.setAdmin})} >取消管理员</a>
            }
            <Divider type="vertical" />
            <a onClick={()=>this.showConfirm({title: '确认删除该账户？',record,cb: this.delAdmin})}>删除</a>
          </span>
        ),
      },
    ]
